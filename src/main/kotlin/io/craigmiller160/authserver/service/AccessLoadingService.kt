...
class AccessLoadingService(
    ...
    fun getAccessForUser(userId: Long): Either<Throwable,UserWithClientsAccess> =
            either.eager<Throwable, UserWithClientsAccess> {
                val user = Either.catch { userRepo.findEnabledUserById(userId) }
                ...
                UserWithClientsAccess(
                    ...
                    .mapLeft { ex -> AccessNotFoundException("Error getting access for User with ID: $userId", ex) }
