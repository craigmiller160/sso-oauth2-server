...
class RefreshTokenRepositoryTest {
    ...
    @BeforeEach
    fun setup() {
        token1 = RefreshToken(0L, "ABC", LocalDateTime.of(2020, 1, 1, 1, 1))
        token2 = RefreshToken(0L, "DEF", LocalDateTime.of(2020, 2, 2, 2, 2))
        token3 = RefreshToken(0L, "GHI", LocalDateTime.now())
