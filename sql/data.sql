...
VALUES (1, 'ClientCredsApp', 'client_creds', '{bcrypt}$2a$10$HYKpEK6BFUFH99fHm5yOhuk4hn1gFErtLveeonVSHW1G7n5bUhGUe', true, true, false, false, 300, 3600, null, null),
       ...
       (4, 'auth-management-service', 'a4cc4fef-564e-44c1-82af-45572f124c1a', '{bcrypt}$2a$10$Mo7pB5wHzuChfanS1c9vOOKRmdn0.TEWDi43yjd6jstdkHtmT/FXa', true, false, true, true, 300, 3600, 60, 'https://localhost:7004/api/oauth/authcode/code');
