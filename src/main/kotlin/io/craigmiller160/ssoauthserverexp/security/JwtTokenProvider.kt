...
class JwtTokenProvider (
    ...
    private fun generateExpiration(): Date {
        ...
        val exp = now.plusSeconds(tokenConfig.accessExpSecs.toLong())
        return legacyDateConverter.convertLocalDateTimeToDate(exp)
    }

    override fun createToken(user: User, params: Map<String,Any>): String {
        ...
        val signer = MACSigner(tokenConfig.keyString) // TODO switch to RSA
        jwt.sign(signer)
        return jwt.serialize()
    }

    override fun resolveToken(req: HttpServletRequest): String? {
        TODO("Need new resolution... or just drop this")
    }
